...
// pattern the rest of AdminPage uses (a list that swaps for a full-screen
// detail on tap, back button undoes it) rather than the desktop build's
// permanent two-column split, which doesn't fit a phone width.
